...
<html>
  <head>
    ...
    <script src="https://kit.fontawesome.com/acf691914f.js" crossorigin="anonymous"></script>
  ...
  <body>
    <main>
      <div class="search-container">
        <form id="uv-form" class="">
          <h1>Steller Net Search</h1>
          <div class="search">
            <input
              id="uv-search-engine"
              ...
              type="hidden"
            />
            <input id="uv-address" type="text" placeholder="Search..." />
